...
# Pilih kategori
category = st.radio("Category job ", df["Job_Category"].unique())
...
st.text("Semakin besar angka, semakin penting kriteria tersebut.")
...
if np.any(criteria_values == 0):
    st.warning("❗ Semua kriteria harus diisi (tidak boleh nol) untuk menggunakan AHP.")
else:
